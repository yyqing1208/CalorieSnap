...
import com.example.caloriesnap.databinding.ActivityMainBinding
import java.io.ByteArrayOutputStream
import android.widget.Button
import com.android.volley.toolbox.JsonObjectRequest
import com.android.volley.toolbox.Volley
import com.example.caloriesnap.FoodRecords
...
class MainActivity : AppCompatActivity() {
    ...
    private var caloriesToday: Int = 0 // Initialize with 0
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnFoodRecords.setOnClickListener {
            val intent = Intent(this, FoodRecords::class.java)
            startActivity(intent)


        }

        // Find the button by its ID using View Binding
